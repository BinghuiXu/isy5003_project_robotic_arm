...
input_position("269.20,31.12,-45,90,10,1000")
input_position("269.20,31.12,-45,90,71,1000")
input_position("269.20,31.12,100,90,71,1000")


# def go_catch(x_y):
'''
# go to the new position
new_position1 = "{:.2f},{:.2f},-45,90,10,1000".format(x_y[0], x_y[1])
print(new_position1)
# time.sleep(5)
input_position(new_position1)

# grab the test strip first time
new_position2 = "{:.2f},{:.2f},-45,90,71,1000".format(x_y[0], x_y[1])
print(new_position2)
input_position(new_position2)

# grab the test strip up
new_position3 = "{:.2f},{:.2f},100,90,71,1000".format(x_y[0], x_y[1])
print(new_position3)
input_position(new_position3)
'''
